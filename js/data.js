...
,
  // ── Artiklar ──────────────────────────────────────────
  {
    ...
    kategori: 'artiklar',
    källa: 'Pract Neurol 2008',
    pdf: 'papers/4A7884B3-820E-4B4C-8587-133D336C1012.pdf',
    innehall: [
      { rubrik: 'Myelopathy but normal MRI', text: 'Review of spinal cord syndromes presenting without MRI abnormality. Differential diagnosis and investigation approach for myelopathy with normal MRI.' }
    ]
  },
  {
    id: 'prognos-hjartstopp',
    titel: 'Bedömning av neurologisk prognos efter hjärtstopp',
    kategori: 'artiklar',
    källa: 'Läkartidningen 2017',
    pdf: 'papers/51F1599A-2FCA-423A-B1D4-AC8026090E6C.pdf',
    innehall: [
      { rubrik: 'Neurologisk prognos efter hjärtstopp', text: 'Uppdaterade rekommendationer från Svenska HLR-rådets expertgrupp för bedömning av neurologisk prognos hos medvetslös patient efter hjärtstopp.' }
    ]
  },
  {
    id: 'cerebellar-ataxia',
    titel: 'A practical approach to late-onset cerebellar ataxia',
    kategori: 'artiklar',
    källa: 'Pract Neurol 2012',
